...
router.post('/fee-structure', rbacMiddleware('finance'), validate(feeRateSchema), controller.upsertFeeRate);
router.get('/invoices', yearContextMiddleware, rbacMiddleware('finance'), controller.listInvoices);
router.post('/invoices/generate', rbacMiddleware('finance'), validate(generateInvoiceSchema), controller.generateInvoices);
router.get('/invoices/:id', rbacMiddleware('finance'), controller.getInvoiceDetail);
router.post('/payments', rbacMiddleware('finance'), validate(paymentSchema), controller.recordPayment);
router.get('/sponsorships', yearContextMiddleware, rbacMiddleware('finance'), controller.listSponsorships);
router.post('/sponsorships', rbacMiddleware('finance'), validate(sponsorshipSchema), controller.upsertSponsorship);
